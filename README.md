# Notion Voice CoPilot - Inbound IVR Service

The Inbound IVR Service is responsible for handling incoming calls in the Notion Voice CoPilot system. It manages the Interactive Voice Response (IVR) functionality, call routing, and integration with the main application service.

## Directory Structure

```
inbound/
├── inbound_ivr.py                     # Main inbound IVR entry point
...
```
# App Configuration
CCAAS_APP_INBOUND_URL=<your-inbound-ivr-service-url>
